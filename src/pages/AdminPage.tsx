...
import { 
  ...
  AlertTriangle,
  Settings,
  FileText, // Documents tab ikonkasi uchun kerak
} from "lucide-react";
import { Button } from "@/components/ui/button";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import Documents from "./Documents";
import { UserStats, initialAdminStats } from "@/data/adminStats"; // <-- Bu yerda o'zgarish

export default function Admin() {
  const [stats] = useState<UserStats>(initialAdminStats); // <-- Bu yerda o'zgarish
        ...
        <header className="pt-12 pb-6 px-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Barcha admin amallari shu yerda</p>
            </div>
          </div>
        </header>
        ...
        <div className="px-4">
          <Tabs defaultValue="dashboard" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-4 bg-black/30 backdrop-blur-sm">
              <TabsTrigger value="dashboard" className="text-white data-[state=active]:bg-blue-600/70">
                <BarChart3 className="h-4 w-4 mr-1" />
                Umumiy statistika
              </TabsTrigger>
              <TabsTrigger value="documents" className="text-white data-[state=active]:bg-blue-600/70">
            ...
            <TabsContent value="dashboard">
              ...
              <section className="px-0 space-y-3 opacity-50 pointer-events-none">
              ...
              <section className="px-0 mt-6 opacity-50 pointer-events-none">
              ...
              <section className="px-0 mt-6 text-center">
